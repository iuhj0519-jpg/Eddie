...
tcad 브랜치에는 tcad_project/만 추적하고, 이 하위에 프로젝트 구조를 구성한다.
...
- 완료 후 Project_Git 기반 통합 브랜치에 tcad_project/만 가져와 검증하고 PR로 통합한다.
- 다른 프로젝트 삭제가 전파되므로 tcad를 Project_Git에 직접 merge하지 않는다.
