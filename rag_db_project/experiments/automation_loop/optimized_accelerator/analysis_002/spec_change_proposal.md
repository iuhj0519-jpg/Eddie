...
- PPA-MEMORY-MAPPING-001: Requested block-memory mapping is absent. An SRAM module name or synchronous output register does not prove BRAM inference. Review banked storage/ROM inference and address selection, independently of the LUT hotspot threshold.
